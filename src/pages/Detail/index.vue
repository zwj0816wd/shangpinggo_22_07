        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for=" spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id" :ref="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuSaleAttrValue.isChecked == 1 }"
                  ...
                  @click="selectActive(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)">{{
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number="skuNum" @change="handleSkuNum">
...
export default {
  ...
  mounted() {
    ...
    //console.log(this.$store.state.detail.uuid_token);
  },
  computed: {
    ...mapGetters(['categoryView', 'skuInfo', 'spuSaleAttrList'])
  },
  methods: {
    selectActive(selectAttrValue, arr) {
      //选择后将其他dd颜色变为无
      arr.forEach(e => {
        e.isChecked = 0
      });
      //然后把当前选择的变色
      selectAttrValue.isChecked = 1
    },
    //处理用户输入的手机个数
    handleSkuNum(e) {
      //使用户输入的变为数字或NAN
